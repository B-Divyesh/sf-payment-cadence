...
function renderToday(): string {
  if (!invoices.length) return `
    <section class="welcome">
      ...
      <picture class="hero-art"><source media="(max-width: 600px)" srcset="/assets/gentle-nudge-landscape-640.webp"><img src="/assets/gentle-nudge-landscape-960.webp" width="960" height="640" alt="A surreal paper landscape where an envelope rests on three coral stepping stones beneath a blue moon" decoding="async" fetchpriority="high"></picture>
    </section>`;
